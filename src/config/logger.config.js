...
// The below transport configuration enables logging in the file app.log
allowedTransports.push(
...
const logger = winston.createLogger({
  ...
  format: winston.format.combine(
    //First argument to the combine method is defing how we can want the timestamp to come up
